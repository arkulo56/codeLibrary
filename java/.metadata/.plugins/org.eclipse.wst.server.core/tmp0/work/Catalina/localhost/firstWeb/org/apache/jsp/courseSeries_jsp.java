 ...
 * Generated at: 2016-04-23 09:48:04 UTC
...
import action.CourseItemAction;
import model.*;
import action.CourseAction;
import java.util.*;
import action.CourseSeriesAction;

public final class courseSeries_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("action.CourseItemAction");
    _jspx_imports_classes.add("action.CourseAction");
    _jspx_imports_classes.add("action.CourseSeriesAction");
  }
...
return;
    ...
    try {
      ...
      out.write("<title>课程系列列表</title>\n");
      out.write("<style type=\"text/css\">\n");
      out.write("li{line-height: 200%}\n");
      out.write("</style>\n");
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("\n");
...
List<CourseSeries> courseSeriesRes = csa.get(wh1);
      ...
      out.write("\n");
      out.write("<h1>推荐课程系列 ");
      out.print(courseRes.get(0).getClassDate() );
      out.write("</h1>\n");
      out.write("<h4><a href=\"＃\" onclick=\"javascript:history.back(-1);\">返回上一层</a></h4>\n");
      out.write("<hr>\n");
